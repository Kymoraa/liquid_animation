...
class _LiquidAnimationState extends State<LiquidAnimation> with TickerProviderStateMixin {
...
class FlaskPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final flask = Path();
    flask.moveTo(
        math.sin(vector.radians(15.0)) * size.width / 2, -math.cos(vector.radians(15.0)) * size.height / 2 - 40);
...
class WavePainter extends CustomPainter {
  ...
  WavePainter({required this.isRightDirection, this.animationController});
  static const int kWaveLength = 280;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Gradient gradient = LinearGradient(
        ...
        colors: const <Color>[Color(0xFFFFA27D), Color(0xFFC83831)],
